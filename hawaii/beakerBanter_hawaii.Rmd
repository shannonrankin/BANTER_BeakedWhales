...
libraries("PAMpal", "banter", "rfPermute", "kableExtra", "magick", "magrittr", "ggplot1", "here")
here()
```
...
ec_hawaii_proximityPlot <- plotProximity(banter_model_ec_RF, plot = FALSE)
ec_hawaii_proximityPlot$g + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
ec_hawaii_proximityPlot <- plotProximity(banter_model_ec_RF, label.size=16)

png(('../manuscript/manuscript_files/hawaii_ici_proximity.png'), width = 20, height = 20, units = 'cm',  res = 300)
ici_hawaii_proximityPlot <- plotProximity(banter_model_ici_RF, plot = FALSE)
ici_hawaii_proximityPlot$g + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
ici_hawaii_proximityPlot <- plotProximity(banter_model_ici_RF, label.size=16)
```
...
ec_hawaii_plotImportance <- plotImportance(banter_model_ec_RF, plot.type="heatmap",n=10, plot = FALSE)
ec_hawaii_plotImportance + theme(axis.text = element_text(size = 16),
...
ici_hawaii_plotImportance <- plotImportance(banter_model_ici_RF, plot.type="heatmap",n=10, plot = FALSE)
ici_hawaii_plotImportance + theme(axis.text = element_text(size = 16),
                                      axis.text.x = element_text(angle = -30, vjust = 1, hjust = 0),
                                      legend.text = element_text(size = 16)
                                      )
dev.off()
...
ec_hawaii_plotVotes <- plotVotes(banter_model_ec_RF, plot = FALSE)
ec_hawaii_plotVotes + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
...
ici_hawaii_plotVotes <- plotVotes(banter_model_ici_RF, plot = FALSE)
ici_hawaii_plotVotes + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
