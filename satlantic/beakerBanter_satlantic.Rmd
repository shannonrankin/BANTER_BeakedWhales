...
libraries("PAMpal", "banter", "rfPermute", "kableExtra", "readxl", "stringr", "magick", "magrittr", "ggplot2", "here")
here()
```
...
ec_satlantic_proximityPlot <- plotProximity(banter_model_ec_RF, plot = FALSE)
ec_satlantic_proximityPlot$g + theme(axis.text = element_text(size = 16),
...
ici_satlantic_proximityPlot <- plotProximity(banter_model_ici_RF, plot = FALSE)
ici_satlantic_proximityPlot$g + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
...
env_satlantic_proximityPlot <- plotProximity(banter_model_env_RF, plot = FALSE)
env_satlantic_proximityPlot$g + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
...
alt_satlantic_proximityPlot <- plotProximity(banter_model_alt_RF, plot = FALSE)
alt_satlantic_proximityPlot$g + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
...
ec_satlantic_plotImportance <- plotImportance(banter_model_ec_RF, plot.type="heatmap",n=10, plot = FALSE)
ec_satlantic_plotImportance + theme(axis.text = element_text(size = 16),
...
ici_satlantic_plotImportance <- plotImportance(banter_model_ici_RF, plot.type="heatmap",n=10, plot = FALSE)
ici_satlantic_plotImportance + theme(axis.text = element_text(size = 16),
                                      axis.text.x = element_text(angle = -30, vjust = 1, hjust = 0),
                                      legend.text = element_text(size = 16)
                                      )
dev.off()
...
env_satlantic_plotImportance <- plotImportance(banter_model_env_RF, plot.type="heatmap",n=10, plot = FALSE)
env_satlantic_plotImportance + theme(axis.text = element_text(size = 16),
                                      axis.text.x = element_text(angle = -30, vjust = 1, hjust = 0),
                                      legend.text = element_text(size = 16)
                                      )
dev.off()
...
alt_satlantic_plotImportance <- plotImportance(banter_model_alt_RF, plot.type="heatmap",n=10, plot = FALSE)
alt_satlantic_plotImportance + theme(axis.text = element_text(size = 16),
                                      axis.text.x = element_text(angle = -30, vjust = 1, hjust = 0),
                                      legend.text = element_text(size = 16)
                                      )
dev.off()
...
ec_satlantic_plotVotes <- plotVotes(banter_model_ec_RF, plot = FALSE)
ec_satlantic_plotVotes + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
...
ici_satlantic_plotVotes <- plotVotes(banter_model_ici_RF, plot = FALSE)
ici_satlantic_plotVotes + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
...
env_satlantic_plotVotes <- plotVotes(banter_model_env_RF, plot = FALSE)
env_satlantic_plotVotes + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
...
alt_satlantic_plotVotes <- plotVotes(banter_model_alt_RF, plot = FALSE)
alt_satlantic_plotVotes + theme(axis.text = element_text(size = 16),
                                     axis.title = element_text(size = 16),
                                     legend.text = element_text(size = 16)
                                     )
dev.off()
